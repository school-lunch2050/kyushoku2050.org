<template>
  ...
  <main-menu prev="/main" active selected="cosmopolitan">
    ...
    <template #illustration>
      <kyushoku-img class="illustration--image" width="3157" height="2500" src="illustration/cosmopolitan" fallback="jpg" />
      <text-box key="weblate.main.grid.warm" align="center center" class="illustration--weather--warm font--tex" y="20" x="120" width="200" />
      ...
      <bubble-text
        ...
        :font-size="{ en: 40, ja: 39, 'ja-simple': 40 }"
      />
      <bubble-text
        ...
        :font-size="{ en: 51, ja: 52, 'ja-simple': 31 }"
      />
      <bubble-text
        ...
        :font-size="{ en: 36, ja: 34, 'ja-simple': 40 }"
      />
      <bubble-text
        ...
        :font-size="{ en: 30, ja: 27, 'ja-simple': 35 }"
      ...
      <bubble-text
        ...
        :font-size="{ en: 30, ja: 27, 'ja-simple': 33 }"
